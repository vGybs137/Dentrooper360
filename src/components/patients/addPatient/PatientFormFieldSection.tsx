...
type PatientFormFieldSectionProps = {
...
export function PatientFormFieldSection({
  icon,
  title,
  children,
  className,
}: PatientFormFieldSectionProps) {
  return (
...
export function PatientFormDivider({ className }: { className?: string }) {
