...
import { selectionOutsideWorkingHours } from "@/helpers/schedule/dayFreeHours";
import { applyNewAppointmentFields } from "@/helpers/schedule/createAppointment";
import {
  findFirstFreeSlotMinutes,
  parseQuickAddAppointment,
  type QuickAddNamedCandidate,
  type QuickAddPatientCandidate,
} from "@/helpers/schedule/parseQuickAddAppointment";
import { formatPatientName } from "@/helpers/patients/patientDisplay";
import { requestSync } from "@/helpers/sync/requestSync";
import type { ScheduleHourRange } from "@/helpers/schedule/scheduleHours";
